            ...
            <header className="sticky top-0 z-30 bg-[#0c0c0e]/95 backdrop-blur border-b border-[#27272a] px-3 sm:px-4 lg:px-8 py-2.5 sm:py-3.5 flex items-center justify-between gap-2">
                <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-[10px] sm:text-[11px] text-zinc-500 font-mono truncate">Binance API, Strategy Logic & Risk for {botID}</p>
                    </div>
                </div>
                        ...
                        <div className="space-y-4 sm:space-y-5">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <span
                                        className={`text-xs font-mono font-bold px-2 py-0.5 rounded border ${leverage > 20
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-3.5 bg-[#09090b] border border-[#27272a] rounded gap-3">
                                ...
                                <button
                                    ...
                                    className={`w-11 h-6 rounded-full transition-colors relative p-0.5 border shrink-0 ${avoidLiquidation
                                            ? 'bg-emerald-600 border-emerald-500'
                                            : 'bg-zinc-800 border-zinc-700'
                                        }`}
                                >
                                    <span
                                        className={`block w-4.5 h-4.5 rounded-full bg-white transition-transform ${avoidLiquidation ? 'translate-x-5' : 'translate-x-0.5'
                                            }`}
                                    />
                                </button>
                            </div>
                        ...
                        <div className="space-y-4 sm:space-y-5 pt-1">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between p-3.5 bg-[#09090b] border border-[#27272a] rounded gap-3">
                                <div className="space-y-1 sm:pr-4">
                                    <div className="flex flex-wrap items-center gap-2">
                                        <Radio className={`w-3.5 h-3.5 shrink-0 ${demo ? 'text-amber-400' : 'text-emerald-400'}`} />
                                        <span className="text-xs font-mono font-medium text-zinc-200">
                                            Execution Mode Protocol
                                        </span>
                                        <span
                                            className={`text-[9.5px] sm:text-[10px] font-mono font-bold px-1.5 py-0.5 rounded border ${demo
                                                    ? 'bg-amber-950/60 text-amber-400 border-amber-800'
                                                    : 'bg-emerald-950/60 text-emerald-400 border-emerald-800'
                                                }`}
                                        >
                                            {demo ? 'DEMO MODE' : 'LIVE TRADING'}
                                        </span>
                                    </div>
                                    <p className="text-[10.5px] sm:text-[11px] text-zinc-500 font-mono leading-relaxed">
                                        {demo
                                ...
                                <button
                                    ...
                                    className={`w-12 h-6 rounded-full transition-colors relative p-0.5 border shrink-0 ${!demo
                                            ? 'bg-emerald-600 border-emerald-500'
                                ...
                                >
                                    <span
                                        className={`block w-5 h-5 rounded-full bg-white transition-transform ${!demo ? 'translate-x-6' : 'translate-x-0.5'
                                            }`}
                                    />
                                </button>
                            </div>
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-mono text-zinc-400 flex items-center justify-between">
                                    ...
                                    <span className="text-[10px] text-zinc-500 font-mono hidden sm:inline">Defined in Strategies.ts</span>
                                </label>
                                <select
                                    value={strategyName}
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 border-b border-zinc-800/80 pb-2.5">
                                    ...
                                    <div className="flex items-center gap-1.5 bg-zinc-900/90 border border-amber-500/40 px-2.5 py-1 rounded text-xs font-mono shrink-0 self-start sm:self-auto">
                                        ...
                                        <span className="font-bold text-amber-300">
                                            ${selectedStrategy.MinBalanceRequired?.toFixed(2) || '50.00'} USDT
                                        </span>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 pt-1">
                            <div className="bg-[#09090b] border border-[#27272a] p-3.5 sm:p-4 rounded space-y-1">
                                ...
                                <p className="text-lg sm:text-xl font-mono font-bold text-emerald-400">
                                    +${formatCurrency(user?.PNL ?? 0, 2)} USDT
                                </p>
                            ...
                            <div className="bg-[#09090b] border border-[#27272a] p-3.5 sm:p-4 rounded space-y-1">
                                ...
                                <p className="text-lg sm:text-xl font-mono font-bold text-amber-400">
                                    ${formatCurrency(user?.UnpaidFee ?? 0, 2)} USDT
                                </p>
                                <span className="text-[10px] sm:text-[10.5px] font-mono text-zinc-500 block">
